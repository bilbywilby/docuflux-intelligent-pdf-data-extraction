    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 md:py-16">
          <div className="max-w-3xl mb-12 animate-in fade-in slide-up duration-700">
                ...
                <div className="max-w-2xl">
                  ...
                  <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 rounded-xl border bg-white dark:bg-slate-900">
                      ...
                      <p className="text-xs text-muted-foreground">Automatically identifies billing line items and reconstructs tabular data from scanned documents.</p>
                    </div>
                    <div className="p-4 rounded-xl border bg-white dark:bg-slate-900">
                      <div className="flex items-center gap-2 font-semibold mb-2">
                        <ShieldCheck className="w-4 h-4 text-emerald-600" /> OCR Fallback
                      </div>
                      <p className="text-xs text-muted-foreground">Our intelligent engine runs OCR fallback for scanned images or non-text-layer PDFs to ensure high accuracy.</p>
                    </div>
                  </div>
                </div>
              )}
